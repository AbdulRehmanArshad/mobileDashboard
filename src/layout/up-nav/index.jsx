      ...
      <div className="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        <div className="w-full  mx-auto">
          <nav className="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start">
            <nav>
              <ol className="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16"></ol>
              ...
              <div className="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                ...
                <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                  ...
                  <li className="flex items-center pl-4 xl:hidden">
                    <Link className="block p-0 transition-all ease-nav-brand text-sm text-slate-500">
                  ...
                  <li className="flex items-center px-4">
                    <Link className="p-0 transition-all text-sm ease-nav-brand text-slate-500">
                      <div>
                        <Dropdown size="sm" icon={<SettingIcon />}>
                          <Dropdown.Item
                            className="text-xs"
                            icon={<OffRoundIcon />}
                          >
                  ...
                  <li className="relative flex items-center pr-2">
                    ...
                    <ul className="text-sm transform-dropdown before:font-awesome before:leading-default before:duration-350 before:ease-soft lg:shadow-soft-3xl duration-250 min-w-44 before:sm:right-7.5 before:text-5.5 pointer-events-none absolute right-0 top-0 z-50 origin-top list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-2 py-4 text-left text-slate-500 opacity-0 transition-all before:absolute before:right-2 before:left-auto before:top-0 before:z-50 before:inline-block before:font-normal before:text-white before:antialiased before:transition-all before:content-['\f0d8'] sm:-mr-6 lg:absolute lg:right-0 lg:left-auto lg:mt-2 lg:block lg:cursor-pointer">
                      <li className="relative mb-2">
                        <Link className="ease-soft py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-gray-200 hover:text-slate-700 lg:transition-colors">
                      ...
                      <li className="relative mb-2">
                        <Link className="ease-soft py-1.2 clear-both block w-full whitespace-nowrap rounded-lg px-4 transition-colors duration-300 hover:bg-gray-200 hover:text-slate-700">
                          <div className="flex py-1">
                            <div className="my-auto">
                              <img
                                src=""
